...
class _ScheduleState extends State<Schedule> with TickerProviderStateMixin {
  ...
  List<Color> _getDayGradient(double progress) {
    if (progress == 1.0) {
      return [const Color(0xFF4CAF50), const Color(0xFF8BC34A)]; // Green gradient for complete
    } else if (progress > 0.5) {
      return [const Color(0xFFFF9800), const Color(0xFFFFC107)]; // Orange gradient for partial
    } else if (progress > 0) {
      return [const Color(0xFF2196F3), const Color(0xFF03DAC6)]; // Blue gradient for started
    } else {
      return [const Color(0xFF9E9E9E), const Color(0xFFBDBDBD)]; // Grey gradient for not started
    }
  }
                  ...
                  child: Container(
                    ...
                    child: ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        List<Color> gradientColors = _getDayGradient(progress);
